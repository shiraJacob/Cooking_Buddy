...
📹 A short [example video](Cooking_Buddy_short_video.mp4) demonstrates the full flow: recording ingredients and restrictions, generating a dish image, getting a full recipe response, and exporting to PDF.
